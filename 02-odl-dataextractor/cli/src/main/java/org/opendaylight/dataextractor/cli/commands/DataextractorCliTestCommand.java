 ...
 */
package org.opendaylight.dataextractor.cli.commands;
...
public class DataextractorCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(DataextractorCliTestCommand.class);
    protected final DataextractorCliCommands service;

    public DataextractorCliTestCommand(final DataextractorCliCommands service) {
